...
// Feedback: I told one of you at the table wrong, 
//           englishFromEnglish should only be (english - 25) if english > 25
...
let total = math + khmer + chemistry + physics + history + biology + extraFromEnglish;
let grade;
