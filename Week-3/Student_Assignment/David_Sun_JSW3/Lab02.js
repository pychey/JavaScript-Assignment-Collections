...
const eachProduct = products.find(product => product.id === 'p1');
if (eachProduct) {
    console.log("Product found: ", eachProduct);
} else {
...
const elecProducts = products.filter (product => product.category === 'Electronics');
console.log("Electronics products:");
elecProducts.forEach(product => console.log('- ' + product.name));
