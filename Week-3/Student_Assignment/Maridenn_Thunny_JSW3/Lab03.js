...
const [{name, tasks: [{description}]}, ...other] = userData;
...
const filtered = userData.filter(u => u.name != "Bob");
console.log("Users other than Bob: ", filtered, "\n");
/**
...
console.log("Users with incompleted tasks:");
const fil = userData.filter(u => u.tasks.find(f => f.completed == false));
fil.forEach(a => console.log(a.name));
console.log("\n");
/**
