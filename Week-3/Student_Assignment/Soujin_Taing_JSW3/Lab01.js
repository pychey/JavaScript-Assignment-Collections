...
const {username,email,isOnline,...other}=userProfile;
...
// Destructure sensitive data out and collect the rest
...
// Create updated profile with isOnline set to false
const updatedProfile = {...userProfile,isOnline: false};
